<?php
    ...
    $conn = OpenCon(); 
      ...
      {  
        echo "<script>alert('Error! Invalid Credentials Please Enter Valid Username Or Password ! ');window.location='/gkvhms/official/login.php'</script>";
      }
     }
 ?>
<!doctype html>
...
<body>
          ...
          <a class="nav-link" href="/gkvhms/official/index.html#holiday">Holidays</a>
                    ...
                    <li class="nav-item dropdown"style="font-size: 1.5rem;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="position:absolute; z-index:10;">
                           ...
                           <a href="/gkvhms/official/employeelogin.php"class="dropdown-item"> Employee Login </a>
  ...
  <div class="container-fluid" style="overflow:auto;background-color: skyblue;">
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="/gkvhms/official/login.php" class="list-group-item bg-warning"> Admin Login</a>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body" style="background-color: rgb(6, 83, 134);color: #ffffff; text-align: center;">
                       ADMIN LOGIN HERE
                    </div>
                    <div class="card-body">
                        <form class="form-group" action="/gkvhms/official/login.php" method="post">
    ...
    <footer style="margin-top:10px; border-top: solid black; border-bottom:solid black;">
        <h4 style="text-align: center;">Copyright © 2020 Gurukula Kangri Vishwavidyalaya. All rights reserved</h4><br>
