<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
     ...
     $conn = OpenCon();
       ...
       $sql = "SELECT * FROM `employee` WHERE Username = '$Username' and passcode = '$Password'";
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="/gkvhms/official/employeelogin.php"class="list-group-item bg-warning "> Employee Login </a>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body" style="background-color: rgb(6, 83, 134);color: #ffffff; text-align: center;">
                       EMPLOYEE/TEACHER LOGIN HERE
                    </div>
                    <div class="card-body">
                        <form class="form-group" action="/gkvhms/official/employeelogin.php" method="post">
                        ...
                        <h5 style="color:brown;">If You forgot Your Username Or Password Then Contact To administrator Immediately!</h5>
                    </div> 
                </div>
