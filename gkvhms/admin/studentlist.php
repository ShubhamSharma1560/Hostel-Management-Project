...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin']!=true){
 ...
 $conn = OpenCon();
  $query="SELECT `SerialNo` , `FirstName` , `LastName` , `FatherName` , `Address` ,`ParentMobNo`,`Email`, `DOB` , `Contact`,`Marks`,`Category` ,`Branch` ,`YearOfStudy`,`Hostel` FROM `registration` ";
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="/gkvhms/admin/studentlist.php" class="list-group-item bg-warning">Registered Student Details</a>
...
<h1 style="color:black;background-color:orange; padding:12px 5px; text-align:center;">Total Registered Student List</h1>
