...
{  
    ...
    $Hostel=$_POST['hostel'];
    $Phone=$_POST['phone'];
    $SuggestionDetail=$_POST['suggestiondetail'];
...
if(!$conn)
{
  die("Sorry connection to database is not established:".mysqli_connect_error());
    ...
    $sql="INSERT INTO `suggestion`(`Name`, `Email`,`Username`, `Suggestion`,`Room`,`Course`,`Hostel`,`Contact`, `Brief Suggestion`)  VALUES('$Name','$Email','$Username','$Suggestion','$Room','$Course','$Hostel','$Phone','$SuggestionDetail')";
     ...
     <div class="container-fluid" style="overflow:auto;">
        <div class="row">
            ...
            <div class="list-group">
                    ...
                    <a href="/gkvhms/student/suggestion.php" class="list-group-item bg-warning"> Any SUGGESTION</a>
            ...
            <div class="col-md-9" id="home">
                ...
                <form action="/gkvhms/student/suggestion.php" method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label for="inlineFormCustomSelect">Suggestion Related To</label>
              <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="suggestion" required>
                <option selected value="0">Choose...</option>
                <option value="Food Suggestion">Food suggestion</option>
                <option value="Room Related Suggestion">Room related Suggestion</option>
                <option value="Bathroom Suggestion">Bathroom Suggestion</option>
                <option value="Hostel Maintenance">Hostel Maintenance</option>
                <option value="Security Suggestion">Security Suggestion</option>
            ...
            <div class="form-group">
              <label for="exampleFormControlTextarea1">Brief Suggestion</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" name="suggestiondetail" rows="3"></textarea>
            </div>
