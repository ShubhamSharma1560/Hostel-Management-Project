...
<body>
   ...
   <form action="/gkvhms/employee/complaintresponse.php"method="post">
   ...
   <h1 style="background-color:skyblue; text-align:center; padding: 10px 5px; color:black; margin-bottom:10px;" id="suggestion">Suggestion List</h1>
...
<table class="table table-sm table-responsive table-hover table-secondary table-bordered">
  ...
  <tbody>
      ...
      ?>
            ...
            <td><form name action="/gkvhms/employee/suggestionresponse.php" method="post">
            <input type="text" class="form-control my-5" name="TName" required placeholder="Enter Your Name">
